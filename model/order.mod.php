...
{
	$pay_types = array('' => '未支付', 'alipay' => array('css' => 'label label-info', 'text' => '支付宝'), 'wechat' => array('css' => 'label label-success', 'text' => '微信支付'), 'credit' => array('css' => 'label label-warning', 'text' => '余额支付'), 'delivery' => array('css' => 'label label-primary', 'text' => '吧台支付'), 'baifubao' => array('css' => 'label label-primary', 'text' => '百付宝支付'), 'cash' => array('css' => 'label label-primary', 'text' => '现金支付'));
	return $pay_types;
}
